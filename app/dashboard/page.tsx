    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 to-purple-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">Módulos del Sistema</h2>
            <ModuleMenu />
          </div>

          <div className="mt-12">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">Cotizaciones Recientes</h2>
            <RecentQuotations />
          </div>
        </div>
      </div>
